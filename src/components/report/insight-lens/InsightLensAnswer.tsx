    ...
    >
      ...
      <div className="flex-1 min-w-0">
        {isUser ? (
          ...
          <>
            <div className="prose prose-sm max-w-none text-sm text-foreground [&>p]:my-1.5 [&>p]:text-foreground [&>ul]:my-1.5 [&>ol]:my-1.5 [&>strong]:text-foreground [&>h3]:text-foreground">
