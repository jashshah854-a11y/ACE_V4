...
class SimulationEngine:
    ...
    def apply_modification(
        ...
        Args:
            ...
            target_column: Column to modify
            modification_factor: Multiplication factor (e.g., 1.1 for 10% increase)
        ...
        # Apply modification
        logger.info(f"[SIMULATION] Modifying {target_column} by factor {modification_factor}")
        df_sim[target_column] = df_sim[target_column] * modification_factor
